...
const ProductCard = ({ p }) => {
  ...
  return (
    <div
      className="max-w-sm relative bg-[#1A1A1A] rounded-lg shaodw dark:bg-gray-800
  dark:border-gray-700"
    >
      <section className="relative">
        <Link to={`/product/${p._id}`}>
          <span
            className="absolute bottom-3 right-3 bg-pink-100 text-pink-800 text-sm font-medium
      ...
      <div className="p-5">
        ...
        <section className="flex justify-between items-center">
          ...
          >
            Read More
            {/* svg is nothing but just arrow icon */}
            <svg
