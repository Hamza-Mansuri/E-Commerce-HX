          ...
          <div className="bg-[#151515] p-3 mt-2 mb-2">
            ...
            <div className="p-5">
              {uniqueBrands?.map((brand) => (
                <div key={brand} className="flex items-center mr-4 mb-5">
                  ...
                  <label
                    htmlFor={brand} // This should match the `id` of the input
                    className="ml-2 text-sm font-medium text-white dark:text-gray-300"
                  >
                    {brand}
                    {/* The brand name should be wrapped in curly braces */}
                  </label>
                </div>
              ))}
            </div>
            ...
            <div className="p-5 w-[15rem]">
              <input
                ...
                focus:outline-pone focus:ring focus:border-pink-300"
              />
            </div>
